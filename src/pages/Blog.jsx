...
export default function Blog() {
    ...
    const { cover_image, comments_count, title, published_at, description, reading_time_minutes, public_reactions_count } = blog;
            ...
            <article className="space-y-8 dark:bg-gray-100 dark:text-gray-900">
                <div className="space-y-6">
                    ...
                    <div className="flex items-center -mx-4 overflow-x-auto overflow-y-hidden sm:justify-start flex-nowrap dark:bg-gray-100 dark:text-gray-800">
                        <Link onClick={() => setTabIndex(0)} className={`flex items-center flex-shrink-0 px-5 py-3 ${tabIndex === 0 ? "border border-b-0" : "border-b"} space-x-2  rounded-t-lg dark:border-gray-600 dark:text-gray-900`}>
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="w-4 h-4">
                                <path d="M19 21l-7-5-7 5V5a2 2 0 0 1 2-2h10a2 2 0 0 1 2 2z"></path>
                            </svg>
                            <span>Content</span>
                        </Link>
                        <Link to="author" onClick={() => setTabIndex(1)} className={`flex items-center flex-shrink-0 px-5 py-3 ${tabIndex === 1 ? "border border-b-0" : "border-b"} space-x-2  rounded-t-lg dark:border-gray-600 dark:text-gray-900`}>
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="w-4 h-4">
                        ...
                        <div onClick={() => handleBookmark(blog)} className=' p-3 ml-5 hover:bg-blue-500/50 bg-primary/20 rounded-full hover:scale-105 cursor-pointer'>
